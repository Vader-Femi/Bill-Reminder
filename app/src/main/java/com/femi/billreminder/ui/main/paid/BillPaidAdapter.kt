...
import com.femi.billreminder.databinding.ItemBillPaidBinding
...
class BillPaidAdapter(
...
) : ListAdapter<Bill, BillPaidAdapter.BillsViewHolder>(COMPARATOR) {
    ...
    inner class BillsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val contentBinding = ItemBillPaidBinding.bind(itemView)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): BillPaidAdapter.BillsViewHolder {
        return BillsViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_bill_paid, parent, false)
        )
    }


    override fun onBindViewHolder(holder: BillPaidAdapter.BillsViewHolder, position: Int) {
